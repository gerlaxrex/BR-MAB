...
vector<Experiment*>* ExperimentLoader::load_experiments() {
	string experimentFileName = "exp_config/gridSearchYahoo.txt";
	ifstream input_file(experimentFileName, ifstream::in); //MODIFY HERE TO CHANGE THE EXPERIMENTS FILES
